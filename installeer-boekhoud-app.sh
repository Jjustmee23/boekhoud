...
log "Aanmaken van hulpscripts voor beheer, updates en troubleshooting..."
...
log ""
log "Om de applicatie automatisch bij te werken, gebruik:"
log "  sudo ${APP_DIR}/update-app.sh"
log ""
log "Troubleshooting:"
