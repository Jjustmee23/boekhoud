"/usr/local/lib/python3.9/site-packages/sqlalchemy/orm/session.py", line 2251, in _execute_internal
...
flask_web  | 2025-04-06 18:43:43,647 - app - ERROR - Exception on / [GET]
...
flask_web  |   File "/app/models.py", line 1109, in get_monthly_summary
...
flask_web  | 2025-04-06 18:43:43,669 - routes - ERROR - 500 Server error: 500 Internal Server Error: The server encountered an internal error and was unable to complete your request. Either the server is overloaded or there is an error in the application.
flask_web  | Traceback (most recent call last):
flask_web  |   File "/usr/local/lib/python3.9/site-packages/sqlalchemy/engine/base.py", line 1964, in _exec_single_context
flask_web  |     self.dialect.do_execute(
flask_web  |   File "/usr/local/lib/python3.9/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
...
flask_web  | (Background on this error at: https://sqlalche.me/e/20/f405)
flask_web  |
flask_web  | [2025-04-06 18:43:43 +0000] [16] [ERROR] Error handling request /
flask_web  | Traceback (most recent call last):
flask_web  |   File "/usr/local/lib/python3.9/site-packages/sqlalchemy/engine/base.py", line 1964, in _exec_single_context
flask_web  |     self.dialect.do_execute(
flask_web  |   File "/usr/local/lib/python3.9/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
